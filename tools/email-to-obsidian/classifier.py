...
def _system_prompt() -> str:
    return (
        ...
        "- A '## Video' block with a transcript means the email is a forwarded "
        "video. Classify, title, and summarize from the transcript's content -- "
        "not the bare link -- and pull out concrete action items if any.\n"
